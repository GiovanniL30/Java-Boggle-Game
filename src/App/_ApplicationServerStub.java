...
public class _ApplicationServerStub extends org.omg.CORBA.portable.ObjectImpl implements App.ApplicationServer
{
  ...
  public App.User[] getPlayerWithOnlineStatus ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getPlayerWithOnlineStatus", true);
                $in = _invoke ($out);
                App.User $result[] = App.PlayersHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                return getPlayerWithOnlineStatus (        );
            } finally {
                _releaseReply ($in);
            }
  } // getPlayerWithOnlineStatus
