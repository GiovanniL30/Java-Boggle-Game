...
abstract public class ClientActionsHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_enum_tc (App.ClientActionsHelper.id (), "ClientActions", new String[] { "NEW_MESSAGE", "START_GAME", "NEW_GAME_ROUND", "NO_PLAYER_LOBBY", "WORD_IS_REMOVED_SCORE"} );
    }
    return __typeCode;
  }
