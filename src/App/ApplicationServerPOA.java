 ...
 implements App.ApplicationServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("createLobby", new java.lang.Integer (2));
    _methods.put ("joinLobby", new java.lang.Integer (3));
    _methods.put ("leaveLobby", new java.lang.Integer (4));
    _methods.put ("getLobby", new java.lang.Integer (5));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 2:  // App/ApplicationServer/createLobby
       {
       ...
       case 3:  // App/ApplicationServer/joinLobby
       {
         App.User user = App.UserHelper.read (in);
       ...
       case 4:  // App/ApplicationServer/leaveLobby
       {
         App.User user = App.UserHelper.read (in);
         String lobbyId = in.read_string ();
         App.Response $result = null;
       ...
       case 5:  // App/ApplicationServer/getLobby
       {
         App.Lobby $result[] = null;
         $result = this.getLobby ();
         out = $rh.createReply();
